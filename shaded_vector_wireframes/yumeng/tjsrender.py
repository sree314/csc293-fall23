...
def from_tjs(tjs):
    ...
    # apply mesh simplication 
    print(f"Before: {verts.shape} vertices, {triangles.shape} triangles")
    verts, triangles = fast_simplification.simplify(verts, triangles, 0.15)
    print(f"After: {verts.shape} vertices, {triangles.shape} triangles")
